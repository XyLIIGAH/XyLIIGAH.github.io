  ...
  return `
    <div class="wrap">
      ...
      <section class="hero">
        ...
        <p class="lead">Откройте курс, найдите нужную лекцию и листайте слайды. Нажмите на картинку, чтобы увеличить её на весь экран. Респект улиц Е. Титову, М. Дружинину, К. Болдыреву</p>
      </section>
      <div class="grid">
